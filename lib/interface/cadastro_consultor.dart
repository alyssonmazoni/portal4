...
import 'package:rizzi/interface/cadastro_gerencia.dart';
...
class _CadastroConsultor extends State<CadastroConsultor> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('Cadastro Recepção')),
        body: Container(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => CadastroGerencia()));
                            },
                            child: Text('Seguir',
                                style:
                                TextStyle(fontSize: 10, color: Colors.black)),

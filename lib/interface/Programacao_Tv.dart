...
class ProgramacaoTv extends StatefulWidget {
  _ProgramacaoTv createState() => _ProgramacaoTv();
}

class _ProgramacaoTv extends State<ProgramacaoTv> {
                      ...
                      child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => CadastroPessoal()));
                          },
                          child: Text('Seguir')),
                    ),
                  ),

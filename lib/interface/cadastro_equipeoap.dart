...
class cadastroequipeoap extends StatefulWidget {
  _cadastroequipeoap createState() => _cadastroequipeoap();
}

class _cadastroequipeoap extends State<cadastroequipeoap> {
